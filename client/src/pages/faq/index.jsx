                        ...
                        >
                            ...
                            >
                                ...
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    className={`w-6 h-6 text-gray-400 transform ${openQuestion === index ? "rotate-180" : ""
                                        }`}
                                >
                                    <path
                                        strokeLinecap="round"
                            ...
                            <div
                                id={`answer${index}`}
                                className={`text-xs sm:text-base px-4 pb-5 sm:px-6 sm:pb-6 ${openQuestion === index ? "block" : "hidden"
                                    }`}
                            >
                                <p>{faq.answer}</p>
                            </div>
